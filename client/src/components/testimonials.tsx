...
export function Testimonials() {
  const testimonials = [
    {
      quote: "I love how deeply it analyzes code... it spots potential errors more often than other tools. It's like having a senior engineer review every PR.",
      author: 'Sarah Chen',
      role: 'Technical Founder',
      company: 'TechStart Inc',
    },
    {
      quote: 'DebugDeer routinely catches off-by-ones, edge cases, and even security slips before they hit production. Game changer for our team.',
      author: 'Brandon Mitchell',
      role: 'Senior Staff Software Engineer',
      company: 'CloudScale',
    },
    {
      quote: 'It enforced a more precise UUID validation that saved us from a production issue. The ROI was immediate.',
      author: 'Kyzylo Ivanov',
      role: 'Engineering Lead',
      company: 'DataFlow Systems',
    },
    {
      quote: 'Writing code faster was never the issue; the bottleneck was always code review. DebugDeer is solving that exact problem.',
